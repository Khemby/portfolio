...
export const DotFlow = ({ items }: DotFlowProps) => {
    ...
    return (
        <div className="flex items-center gap-4 border border-[#fafafa] px-4 py-3">
            <DotLoader
            ...
            <div ref={containerRef} className="relative overflow-hidden">
                <div ref={textRef} className="inline-block text-xs font-bold tracking-[0.12em] uppercase whitespace-nowrap text-[#fafafa]">
